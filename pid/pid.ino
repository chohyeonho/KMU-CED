...
#define _DUTY_NEU 1380    // [20213090]서보 수평 각도 펄스 값
#define _DUTY_MAX 1600        // [20213081] 서보 각도의 최댓값
...
// PID parameters
#define _KP 3        //[20191979] 비례제어 값
#define _KD 100.0        // 미분제어 값
#define _KI 0.005        // 적분제어 값
...
float ir_distance_filtered(void){ // return value unit: mm
  ...
  return median; // for now, just use ir_distance() without noise filter.
}
